...
<html>
    <head>
        <title>Original | Online Players</title>
        ...
        <div id="page">
                ...
                <div class="nav-content">
                    ...
                    <div id="sidebar-links">
                        <ul>
                            ...
                            <li class="active"><a href="online.php"><i class="mdi mdi-account-group"></i> <span class="text">Online Players</a></span></li>
            ...
            <div class="page-content">
                ...
                <div class="content-wrap">
                    <div class="container">
                        <h1 class="panel-title">Online Players</h1>
                        <div class="panel-table">
                            <table>
                                <tr>
                                    <th>User</th>
                                    <th class="hidden-mobile">Time Played</th>
                                    <th>Role</th>
                                </tr>
                                <?php
                                    $arr = range(0, 10);
                                ...
                                <tr>
                                    <td class="user"><a href="#"><img class="hidden-mobile" src="https://crafatar.com/avatars/63efbbabeb9a4648a8f0bb83a261eefd?size=32"> Panda110_</a></td>
                                    <td class="hidden-mobile">6 Days</td>
                                    <td><span class="label member">Member</span></td>
                                </tr>
                                <?php } ?>
                            </table>
                        </div>
