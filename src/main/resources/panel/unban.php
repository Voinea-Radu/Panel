        ...
        <div id="page">
                ...
                <div class="nav-content">
                    ...
                    <div id="sidebar-links">
                        <ul>
                            ...
                            <li class="active"><a href="unban.php"><i class="mdi mdi-ticket"></i> <span class="text">Unban Requests</a></span></li>
            ...
            <div class="page-content">
                ...
                <div class="content-wrap">
                    <div class="container">
                        <h1 class="panel-title">Unban Request</h1>
