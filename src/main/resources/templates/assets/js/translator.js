...
translateMap = {
    "donors": "Donatori",
    "registered": "Jucatori Inregistrati",
    "online": "Jucatori online",
    "home": "Acasa",
    "complaints": "Reclamatii",
    "unban": "Cereri Unban",
    "rules": "Regulament",
    "entries": "Intrari",
    "login-button": "Logheaza-te",
    "complain-title": "Creeaza o reclamatie",
    "target-label": "Reclamatul",
    "section-label": "Sectiune",
    "date_and_time-label": "Data si Ora",
    "description-label": "Descriere",
    "proof-label": "Dovada",
    "submit": "Trimite",
    "cancel": "Anuleaza",
    "login-title": "Logheaza-te",
    "username-label": "Nume de utilizator",
    "password-label": "Parola",
    "join-date": "Data Alaturari",
    "playing-hours": "Ore Jucate",
    "unban-title": "Cerere Unban",
    "reason-label": "Motiv",
    "photo-label": "Fotografie cu banul",
    "bug-title": "Raporteaza un bug",
