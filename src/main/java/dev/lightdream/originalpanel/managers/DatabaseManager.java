...
public class DatabaseManager extends ProgrammaticHikariDatabaseManager {
    ...
    public DatabaseManager() {
        ...
        registerDataType(ComplainData.ComplainStatus.class, "TEXT");
        registerDataType(ComplainData.ComplainDecision.class, "TEXT");
        registerDataType(UnbanData.UnbanStatus.class, "TEXT");
        registerDataType(UnbanData.UnbanDecision.class, "TEXT");
        registerDataType(BugsData.BugStatus.class, "TEXT");
        registerDataType(ApplyData.ApplyDecision.class, "TEXT");
        registerDataType(ApplyData.ApplyStatus.class, "TEXT");
    ...
    public List<Complain> getComplains(String username) {
        List<Complain> output = get(Complain.class, new HashMap<>() {{
            put("user", username);
        }}, "id", 10, OrderBy.OrderByType.DESCENDENT);
    ...
    public Complain getLastComplain() {
        return get(Complain.class, new HashMap<>() {{
            put(">id", 0);
        }}, "id", 1, OrderBy.OrderByType.DESCENDENT).stream().findFirst().orElse(null);
    }
    ...
    public List<Complain> getComplains() {
        ...
        }}, "id", 20, OrderBy.OrderByType.ASCENDANT);
    }
